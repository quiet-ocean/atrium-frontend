...
const ChooseName = () => {
  ...
  return (
    <>
      ...
      <p style={{ marginBottom: '12px'}}>Choose your display name to represent yourself in the digital world.</p>
      <InputField label="NAME" value={username} error={nameError} setError={setNameError} handleChange = {handleChange} />
      <InputField label="CONFIRM DISPLAY NAME" error={confirmError} setError={setConfirmError} value={confirmName} handleChange={setConfirmName} />
      <Button onClick={next} className="atrium_btn atrium_btn_primary" sx={{ mt: "56px"}}>NEXT</Button>
