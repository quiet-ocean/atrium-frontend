...
const ChooseWallet = () => {
  ...
  return (
    <>
      ...
      <Button onClick={() => selectWalletType(WalletType.near)} className="atrium_btn" sx={{ mt: "12px" }}>NEAR Wallet</Button>
      <Button onClick={() => selectWalletType(WalletType.sender)} className="atrium_btn">Sender Wallet</Button>
      <Button onClick={login} className="atrium_btn atrium_btn_primary" sx={{ mt: "56px"}}>NEXT</Button>
